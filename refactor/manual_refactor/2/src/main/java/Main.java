...
public class Main 
{
       ...
       try {
        ...
        while( opcao != 4 ){
            ...
            switch( opcao ){
                ...
                case 3: Comparator<Utilizador> c= new ComparatorUser();
    ...
    private static void signIn(DataBase db){
        ...
        String msg = "A sua conta foi registada";
        switch( opcao ){
                  case 1 :
     ...
     * @return  
     */
    private static void defs(Utilizador d){
     ...
     * @return  
     */
    private static void classifica(DataBase db){
     Scanner input = new Scanner(System.in);
     ...
     * @return  
     */
    private static void defsL(Loja d){
    ...
    private static void areaPessoal(Empresa d,DataBase db){
      ...
      while( opcao != 4){
           ...
           switch( opcao ){
                ...
                case 3:
                    System.out.println("Insira a ano:");
                    ano= input.nextInt();
     ...
     * @return  
     */
    private static void defsE(Empresa d){
     ...
     * @return  
     */
    private static void defsV(Voluntario d){

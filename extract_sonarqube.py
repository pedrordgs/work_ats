...
fieldnames = ['name', 'bugs', 'code_smells', 'sqale_index', 'duplicated_blocks', 'duplicated_lines_density']
...
with open('sonarqube_results.csv', 'w', newline='') as file:
    ...
    for p in projects:
        ...
        component = sonar.measures.get_component_with_specified_measures(component=p['key'],
                                                                     ...
                                                                     metricKeys="code_smells,bugs,duplicated_lines_density,duplicated_blocks,sqale_index")
